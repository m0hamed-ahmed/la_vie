...
import 'package:la_vie/domain/usecases/register_usecase.dart';
...
class RegisterCubit extends Cubit<RegisterStates> {
  ...
  register(BuildContext context, String firstName, String lastName, String email, String password) async {
    emit(RegisterLoadingState());
    BaseRemoteDataSource baseRemoteDataSource = RemoteDataSource();
    BaseRepository baseRepository = Repository(baseRemoteDataSource);
    RegisterUsecase registerUsecase = RegisterUsecase(baseRepository);
    await registerUsecase.execute(firstName, lastName, email, password).then((value) {
      value.fold((failure) {
